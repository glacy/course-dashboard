                ...
                <div className="mt-auto space-y-2">
                    {isCollapsed ? (
                        ...
                        <div className="rounded-2xl bg-slate-50 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/5 dark:to-transparent border border-slate-200 dark:border-white/5 mx-4 text-center">
                            <a href="../../public/programa-del-curso.pdf" className="inline-flex items-center justify-center gap-2 w-full text-sm font-medium text-slate-700 dark:text-white bg-white dark:bg-white/10 hover:bg-blue-50 dark:hover:bg-white/20 active:bg-blue-100 dark:active:bg-white/30 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3 transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-[#0b0f19]" role="button" aria-label="Ver programa del curso (abre documento PDF)">
